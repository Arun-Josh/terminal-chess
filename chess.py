...
WHITE = "white"
BLACK = "black"
whitehistory = open("whitehistory.txt","a")
blackhistory = open("blackhistory.txt","a")
whiteval = open("whiteval.txt","a")
blackval = open("blackval.txt","a")
count = 0
    ...
    def main(self):
        ...
        while True:
            ...
            try:
                ...
                self.message = "could not find piece; index is out of range"
                target = None
            ...
            if target:
                ...
                if target.isValid(startpos,endpos,target.Color,self.gameboard):
                    ...
                    if self.playersturn == BLACK:
                        ...
                        blackhistory.write(str((str(endpos))+"-"+(str(startpos))+" "))
                    else :
                    	whitehistory.write(str(str(endpos))+"-"+(str(startpos))+" ")
                    	self.playersturn = BLACK
                else : 
